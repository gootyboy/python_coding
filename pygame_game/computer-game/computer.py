...
def get_letter_from_number(digits, index_of_item):
    for letter, number in password_coding.items():
        if number == digits[index_of_item]:
            return letter
...
def make_password_coded(digits):
    ...
    filename = r"C:\Python_coding\pygame_game\computer-game\password.txt"
...
def get_password_digits():
    filename = r"/Users/gootyboy/Desktop/myrepos/python_coding/pygame_game/computer-game/password.txt"
...
def get_backround():
    ...
    filename = r"/Users/gootyboy/Desktop/myrepos/python_coding/pygame_game/computer-game/background-setting.txt"
    with open(filename, "r") as file:
        line = file.readline()
